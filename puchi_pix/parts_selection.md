...
| Ref | 部品 | パッケージ | JLCPCB# | 備考 |
|-----|------|-----------|---------|------|
| U1 | STM32G030F6Px | TSSOP-20 | C724040 | MCU |
| U2 | KXTJ3-1057 | LGA-12 (2x2mm) | C442603 | 加速度計 |
| U3 | MCP73831-2-OT | SOT-23-5 | C424093 | LiPo充電IC |
| U4 | AP2112K-3.3 | SOT-23-5 | C51118 | 3.3V LDOレギュレータ |
...
| Ref | 種類 | JLCPCB# | 型式 | メモ |
|-----|------|---------|------|------|
| RST1 | タクトスイッチ | C139797 | ALPS ALPINE SKRPACE010 | 4.2x3.2x2.5mm SMD |
| BOOT1 | タクトスイッチ | C139797 | ALPS ALPINE SKRPACE010 | 同上 |
...
- `SKRPACE010.pretty` — タクトスイッチ (C139797) ※パッド名を上段=1, 下段=2にリネーム済み
